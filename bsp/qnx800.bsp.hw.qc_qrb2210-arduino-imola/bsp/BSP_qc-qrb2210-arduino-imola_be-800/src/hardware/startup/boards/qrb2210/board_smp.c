...
#include <soc/st/qrb2210/include/qrb2210_smc_call.h>
...
static const uint64_t qrb2210_core_affinity[6] = {
    0x0000,
    0x0001,
};
...
{
    return QRB2210_CPU_CORES_NUMBER;
}
...
int board_smp_start(const unsigned cpu, void (*start)(void))
{
     ...
     */
    status = qrb2210_sec_firmware_psci(QRB2210_PSCI_CPU_ON_AARCH64, qrb2210_core_affinity[cpu], (uintptr_t)start, 0x00, 0x00);
    if (status != QRB2210_PSCI_SUCCESS) {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/startup/boards/qrb2210/board_smp.c $ $Rev: 984580 $")
#endif
