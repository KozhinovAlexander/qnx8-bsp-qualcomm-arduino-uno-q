...
/*
 * QRB221057F-DK board physical address space information
 */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/startup/boards/qrb2210/init_asinfo.c $ $Rev: 984580 $")
#endif
